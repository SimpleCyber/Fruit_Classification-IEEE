...
st.sidebar.image(
    ["images/banana_good.JPG", "images/apple_good.jpg", "images/orangee_good.JPG", "images/pomogranate_good.jpg"],
    caption=[" Banana", " Apple", " Orange", " Pomegranate"],
    width=120,
)

st.sidebar.write("### Spoiled Fruits")
st.sidebar.image(
    ["images/babana_bad.JPG", "images/apple_bad (2).jpg", "images/orange_bad.jpg", "images/pomogranate_bad.jpg"],
    caption=[" Banana", " Apple", " Orange", " Pomegranate"],
    width=120,
)
